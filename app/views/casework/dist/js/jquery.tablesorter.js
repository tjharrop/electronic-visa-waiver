...
tsff = ts.filterFormatter = {
	...
	uiDatepicker: function($cell, indx, defDate) {
		...
		t = '<label style="display: none">' + o.textFrom + '</label><input type="text" class="dateFrom" placeholder="' +
			($hdr.data('placeholderFrom') || $hdr.attr('data-placeholder-from') || c.widgetOptions.filter_placeholder.from || '') + '" />' +
			'<label style="display: none">' + o.textTo + '</label><input type="text" class="dateTo" placeholder="' +
